...
@testset "Discovery response schema gating" begin
    with_driver_and_client() do driver, client
        ...
        poller = AeronTensorPool.Discovery.DiscoveryResponsePoller(sub)

        out_entries = AeronTensorPool.Discovery.DiscoveryEntry[]
        slot = AeronTensorPool.Discovery.DiscoveryResponseSlot(out_entries)
        ...
        AeronTensorPool.Discovery.handle_discovery_response!(poller, buf)
