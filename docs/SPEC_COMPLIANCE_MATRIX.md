...
| 5 Streams (control/descriptor/QoS/metadata) | Implemented | Compliant | Agents + client APIs publish/subscribe to all channels; separate announce stream covered by `test/test_consumer_announce_stream.jl`. |
