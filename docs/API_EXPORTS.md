...
- init_supervisor, init_driver, init_bridge_sender, init_bridge_receiver, init_decimator
...
- string_ref_view, string_ref_string (driver response StringRef utilities)
