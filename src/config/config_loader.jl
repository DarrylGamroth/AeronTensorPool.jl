...
function load_producer_config(path::AbstractString; env::AbstractDict = ENV)
    ...
    descriptor_stream_id = env_default(env, "TP_DESCRIPTOR_STREAM_ID", Int32(get(prod, "descriptor_stream_id", 1100)))
    control_stream_id = env_default(env, "TP_CONTROL_STREAM_ID", Int32(get(prod, "control_stream_id", 1000)))
    qos_stream_id = env_default(env, "TP_QOS_STREAM_ID", Int32(get(prod, "qos_stream_id", 1200)))
    metadata_stream_id = env_default(env, "TP_METADATA_STREAM_ID", Int32(get(prod, "metadata_stream_id", 1300)))
    stream_id = env_default(env, "TP_STREAM_ID", UInt32(get(prod, "stream_id", 10000)))
...
function load_consumer_config(path::AbstractString; env::AbstractDict = ENV)
    ...
    descriptor_stream_id = env_default(env, "TP_DESCRIPTOR_STREAM_ID", Int32(get(cons, "descriptor_stream_id", 1100)))
    control_stream_id = env_default(env, "TP_CONTROL_STREAM_ID", Int32(get(cons, "control_stream_id", 1000)))
    qos_stream_id = env_default(env, "TP_QOS_STREAM_ID", Int32(get(cons, "qos_stream_id", 1200)))
    stream_id = env_default(env, "TP_STREAM_ID", UInt32(get(cons, "stream_id", 10000)))
...
function load_supervisor_config(path::AbstractString; env::AbstractDict = ENV)
    ...
    stream_id = env_default(env, "TP_STREAM_ID", UInt32(get(sup, "stream_id", 10000)))
