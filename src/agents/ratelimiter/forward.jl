...
function forward_data_source_announce!(
    ...
    return with_claimed_buffer!(pub, mapping.metadata_claim, msg_len) do buf
        ...
        encode_metadata_announce!(state.metadata_announce_encoder, mapping.mapping.dest_stream_id, msg)
    end
end
...
function forward_data_source_meta!(
    ...
    return with_claimed_buffer!(pub, mapping.metadata_claim, msg_len) do buf
        ...
        encode_metadata_meta!(state.metadata_meta_encoder, mapping.mapping.dest_stream_id, msg)
    end
end
...
function forward_progress!(
    ...
    seq = UInt64(FrameProgress.seq(msg))
    return with_claimed_buffer!(pub, state.control_claim, msg_len) do buf
        ...
        FrameProgress.seq!(state.progress_encoder, seq)
