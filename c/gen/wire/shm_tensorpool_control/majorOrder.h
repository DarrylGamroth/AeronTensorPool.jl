...
#ifndef _SHM_TENSORPOOL_CONTROL_MAJORORDER_H_
#define _SHM_TENSORPOOL_CONTROL_MAJORORDER_H_
...
enum shm_tensorpool_control_majorOrder
{
    shm_tensorpool_control_majorOrder_UNKNOWN = (int16_t)0,
    shm_tensorpool_control_majorOrder_ROW = (int16_t)1,
    shm_tensorpool_control_majorOrder_COLUMN = (int16_t)2,
    shm_tensorpool_control_majorOrder_NULL_VALUE = (int16_t)-32768
};

SBE_ONE_DEF bool shm_tensorpool_control_majorOrder_get(
    const int16_t value,
    enum shm_tensorpool_control_majorOrder *const out)
{
    ...
    {
        case (int16_t)0:
             *out = shm_tensorpool_control_majorOrder_UNKNOWN;
             return true;
        case (int16_t)1:
             *out = shm_tensorpool_control_majorOrder_ROW;
             return true;
        case (int16_t)2:
             *out = shm_tensorpool_control_majorOrder_COLUMN;
             return true;
        case (int16_t)-32768:
             *out = shm_tensorpool_control_majorOrder_NULL_VALUE;
             return true;
    }
