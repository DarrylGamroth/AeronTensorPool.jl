...
#ifndef _SHM_TENSORPOOL_CONTROL_PROGRESSUNIT_H_
#define _SHM_TENSORPOOL_CONTROL_PROGRESSUNIT_H_
...
enum shm_tensorpool_control_progressUnit
{
    shm_tensorpool_control_progressUnit_NONE = (uint8_t)0,
    shm_tensorpool_control_progressUnit_ROWS = (uint8_t)1,
    shm_tensorpool_control_progressUnit_COLUMNS = (uint8_t)2,
    shm_tensorpool_control_progressUnit_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool shm_tensorpool_control_progressUnit_get(
    const uint8_t value,
    enum shm_tensorpool_control_progressUnit *const out)
{
    ...
    {
        case (uint8_t)0:
             *out = shm_tensorpool_control_progressUnit_NONE;
             return true;
        case (uint8_t)1:
             *out = shm_tensorpool_control_progressUnit_ROWS;
             return true;
        case (uint8_t)2:
             *out = shm_tensorpool_control_progressUnit_COLUMNS;
             return true;
        case (uint8_t)255:
             *out = shm_tensorpool_control_progressUnit_NULL_VALUE;
             return true;
    }
