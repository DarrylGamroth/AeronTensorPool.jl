...
#ifndef _SHM_TENSORPOOL_CONTROL_CLOCKDOMAIN_H_
#define _SHM_TENSORPOOL_CONTROL_CLOCKDOMAIN_H_
...
enum shm_tensorpool_control_clockDomain
{
    shm_tensorpool_control_clockDomain_MONOTONIC = (uint8_t)1,
    shm_tensorpool_control_clockDomain_REALTIME_SYNCED = (uint8_t)2,
    shm_tensorpool_control_clockDomain_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool shm_tensorpool_control_clockDomain_get(
    const uint8_t value,
    enum shm_tensorpool_control_clockDomain *const out)
{
    ...
    {
        case (uint8_t)1:
             *out = shm_tensorpool_control_clockDomain_MONOTONIC;
             return true;
        case (uint8_t)2:
             *out = shm_tensorpool_control_clockDomain_REALTIME_SYNCED;
             return true;
        case (uint8_t)255:
             *out = shm_tensorpool_control_clockDomain_NULL_VALUE;
             return true;
    }
