...
#ifndef _SHM_TENSORPOOL_CONTROL_RESPONSECODE_H_
#define _SHM_TENSORPOOL_CONTROL_RESPONSECODE_H_
...
enum shm_tensorpool_control_responseCode
{
    shm_tensorpool_control_responseCode_OK = INT32_C(0),
    shm_tensorpool_control_responseCode_UNSUPPORTED = INT32_C(1),
    shm_tensorpool_control_responseCode_INVALID_PARAMS = INT32_C(2),
    shm_tensorpool_control_responseCode_REJECTED = INT32_C(3),
    shm_tensorpool_control_responseCode_INTERNAL_ERROR = INT32_C(4),
    shm_tensorpool_control_responseCode_NULL_VALUE = INT32_MIN
};

SBE_ONE_DEF bool shm_tensorpool_control_responseCode_get(
    const int32_t value,
    enum shm_tensorpool_control_responseCode *const out)
{
    ...
    {
        case INT32_C(0):
             *out = shm_tensorpool_control_responseCode_OK;
             return true;
        case INT32_C(1):
             *out = shm_tensorpool_control_responseCode_UNSUPPORTED;
             return true;
        case INT32_C(2):
             *out = shm_tensorpool_control_responseCode_INVALID_PARAMS;
             return true;
        case INT32_C(3):
             *out = shm_tensorpool_control_responseCode_REJECTED;
             return true;
        case INT32_C(4):
             *out = shm_tensorpool_control_responseCode_INTERNAL_ERROR;
             return true;
        case INT32_MIN:
             *out = shm_tensorpool_control_responseCode_NULL_VALUE;
             return true;
    }
