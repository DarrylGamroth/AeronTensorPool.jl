...
#ifndef _SHM_TENSORPOOL_CONTROL_BOOL_H_
#define _SHM_TENSORPOOL_CONTROL_BOOL_H_
...
enum shm_tensorpool_control_bool
{
    shm_tensorpool_control_bool_FALSE = (uint8_t)0,
    shm_tensorpool_control_bool_TRUE = (uint8_t)1,
    shm_tensorpool_control_bool_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool shm_tensorpool_control_bool_get(
    const uint8_t value,
    enum shm_tensorpool_control_bool *const out)
{
    ...
    {
        case (uint8_t)0:
             *out = shm_tensorpool_control_bool_FALSE;
             return true;
        case (uint8_t)1:
             *out = shm_tensorpool_control_bool_TRUE;
             return true;
        case (uint8_t)255:
             *out = shm_tensorpool_control_bool_NULL_VALUE;
             return true;
    }
