...
#ifndef _SHM_TENSORPOOL_CONTROL_FRAMEPROGRESSSTATE_H_
#define _SHM_TENSORPOOL_CONTROL_FRAMEPROGRESSSTATE_H_
...
enum shm_tensorpool_control_frameProgressState
{
    shm_tensorpool_control_frameProgressState_UNKNOWN = (uint8_t)0,
    shm_tensorpool_control_frameProgressState_STARTED = (uint8_t)1,
    shm_tensorpool_control_frameProgressState_PROGRESS = (uint8_t)2,
    shm_tensorpool_control_frameProgressState_COMPLETE = (uint8_t)3,
    shm_tensorpool_control_frameProgressState_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool shm_tensorpool_control_frameProgressState_get(
    const uint8_t value,
    enum shm_tensorpool_control_frameProgressState *const out)
{
    ...
    {
        case (uint8_t)0:
             *out = shm_tensorpool_control_frameProgressState_UNKNOWN;
             return true;
        case (uint8_t)1:
             *out = shm_tensorpool_control_frameProgressState_STARTED;
             return true;
        case (uint8_t)2:
             *out = shm_tensorpool_control_frameProgressState_PROGRESS;
             return true;
        case (uint8_t)3:
             *out = shm_tensorpool_control_frameProgressState_COMPLETE;
             return true;
        case (uint8_t)255:
             *out = shm_tensorpool_control_frameProgressState_NULL_VALUE;
             return true;
    }
