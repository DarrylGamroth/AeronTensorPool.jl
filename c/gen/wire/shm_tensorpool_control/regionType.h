...
#ifndef _SHM_TENSORPOOL_CONTROL_REGIONTYPE_H_
#define _SHM_TENSORPOOL_CONTROL_REGIONTYPE_H_
...
enum shm_tensorpool_control_regionType
{
    shm_tensorpool_control_regionType_HEADER_RING = (int16_t)1,
    shm_tensorpool_control_regionType_PAYLOAD_POOL = (int16_t)2,
    shm_tensorpool_control_regionType_NULL_VALUE = (int16_t)-32768
};

SBE_ONE_DEF bool shm_tensorpool_control_regionType_get(
    const int16_t value,
    enum shm_tensorpool_control_regionType *const out)
{
    ...
    {
        case (int16_t)1:
             *out = shm_tensorpool_control_regionType_HEADER_RING;
             return true;
        case (int16_t)2:
             *out = shm_tensorpool_control_regionType_PAYLOAD_POOL;
             return true;
        case (int16_t)-32768:
             *out = shm_tensorpool_control_regionType_NULL_VALUE;
             return true;
    }
