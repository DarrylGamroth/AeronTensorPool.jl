...
#ifndef _SHM_TENSORPOOL_CONTROL_MODE_H_
#define _SHM_TENSORPOOL_CONTROL_MODE_H_
...
enum shm_tensorpool_control_mode
{
    shm_tensorpool_control_mode_STREAM = (uint8_t)1,
    shm_tensorpool_control_mode_RATE_LIMITED = (uint8_t)2,
    shm_tensorpool_control_mode_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool shm_tensorpool_control_mode_get(
    const uint8_t value,
    enum shm_tensorpool_control_mode *const out)
{
    ...
    {
        case (uint8_t)1:
             *out = shm_tensorpool_control_mode_STREAM;
             return true;
        case (uint8_t)2:
             *out = shm_tensorpool_control_mode_RATE_LIMITED;
             return true;
        case (uint8_t)255:
             *out = shm_tensorpool_control_mode_NULL_VALUE;
             return true;
    }
