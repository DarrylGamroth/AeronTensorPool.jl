...
#ifndef _SHM_TENSORPOOL_DISCOVERY_DISCOVERYSTATUS_H_
#define _SHM_TENSORPOOL_DISCOVERY_DISCOVERYSTATUS_H_
...
enum shm_tensorpool_discovery_discoveryStatus
{
    shm_tensorpool_discovery_discoveryStatus_OK = (uint8_t)1,
    shm_tensorpool_discovery_discoveryStatus_NOT_FOUND = (uint8_t)2,
    shm_tensorpool_discovery_discoveryStatus_ERROR = (uint8_t)3,
    shm_tensorpool_discovery_discoveryStatus_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool shm_tensorpool_discovery_discoveryStatus_get(
    const uint8_t value,
    enum shm_tensorpool_discovery_discoveryStatus *const out)
{
    ...
    {
        case (uint8_t)1:
             *out = shm_tensorpool_discovery_discoveryStatus_OK;
             return true;
        case (uint8_t)2:
             *out = shm_tensorpool_discovery_discoveryStatus_NOT_FOUND;
             return true;
        case (uint8_t)3:
             *out = shm_tensorpool_discovery_discoveryStatus_ERROR;
             return true;
        case (uint8_t)255:
             *out = shm_tensorpool_discovery_discoveryStatus_NULL_VALUE;
             return true;
    }
