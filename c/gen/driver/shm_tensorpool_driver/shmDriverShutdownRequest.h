...
#ifndef _SHM_TENSORPOOL_DRIVER_SHMDRIVERSHUTDOWNREQUEST_H_
#define _SHM_TENSORPOOL_DRIVER_SHMDRIVERSHUTDOWNREQUEST_H_
...
struct shm_tensorpool_driver_shmDriverShutdownRequest
{
    char *buffer;
...
enum shm_tensorpool_driver_shmDriverShutdownRequest_meta_attribute
{
    shm_tensorpool_driver_shmDriverShutdownRequest_meta_attribute_EPOCH,
    shm_tensorpool_driver_shmDriverShutdownRequest_meta_attribute_TIME_UNIT,
    shm_tensorpool_driver_shmDriverShutdownRequest_meta_attribute_SEMANTIC_TYPE,
    shm_tensorpool_driver_shmDriverShutdownRequest_meta_attribute_PRESENCE
};

union shm_tensorpool_driver_shmDriverShutdownRequest_float_as_uint
{
    float fp_value;
    uint32_t uint_value;
};

union shm_tensorpool_driver_shmDriverShutdownRequest_double_as_uint
{
    double fp_value;
    uint64_t uint_value;
};

struct shm_tensorpool_driver_shmDriverShutdownRequest_string_view
{
    const char* data;
    size_t length;
};

SBE_ONE_DEF uint64_t shm_tensorpool_driver_shmDriverShutdownRequest_sbe_position(
    const struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
    return codec->position;
}

SBE_ONE_DEF bool shm_tensorpool_driver_shmDriverShutdownRequest_set_sbe_position(
...
SBE_ONE_DEF uint64_t *shm_tensorpool_driver_shmDriverShutdownRequest_sbe_position_ptr(
    struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
    return &codec->position;
}

SBE_ONE_DEF struct shm_tensorpool_driver_shmDriverShutdownRequest *shm_tensorpool_driver_shmDriverShutdownRequest_reset(
    struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec,
    char *buffer,
    ...
    const uint64_t acting_version)
{
    ...
    if (!shm_tensorpool_driver_shmDriverShutdownRequest_set_sbe_position(codec, offset + acting_block_length))
    {
        return NULL;
    }
...
SBE_ONE_DEF struct shm_tensorpool_driver_shmDriverShutdownRequest *shm_tensorpool_driver_shmDriverShutdownRequest_copy(
    struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec,
    const struct shm_tensorpool_driver_shmDriverShutdownRequest *const other)
{
...
SBE_ONE_DEF uint16_t shm_tensorpool_driver_shmDriverShutdownRequest_sbe_template_id(void)
{
    return (uint16_t)8;
}

SBE_ONE_DEF uint16_t shm_tensorpool_driver_shmDriverShutdownRequest_sbe_schema_id(void)
{
    return (uint16_t)901;
}

SBE_ONE_DEF uint16_t shm_tensorpool_driver_shmDriverShutdownRequest_sbe_schema_version(void)
{
    return (uint16_t)1;
}

SBE_ONE_DEF const char* shm_tensorpool_driver_shmDriverShutdownRequest_sbe_semantic_version(void)
{
    return "1.0";
}

SBE_ONE_DEF const char *shm_tensorpool_driver_shmDriverShutdownRequest_sbe_semantic_type(void)
{
    return "";
}

SBE_ONE_DEF uint64_t shm_tensorpool_driver_shmDriverShutdownRequest_offset(
    const struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
    return codec->offset;
}

SBE_ONE_DEF struct shm_tensorpool_driver_shmDriverShutdownRequest *shm_tensorpool_driver_shmDriverShutdownRequest_wrap_and_apply_header(
    struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec,
    char *buffer,
    const uint64_t offset,
    const uint64_t buffer_length,
    struct shm_tensorpool_driver_messageHeader *const hdr)
{
    ...
    shm_tensorpool_driver_messageHeader_set_blockLength(hdr, shm_tensorpool_driver_shmDriverShutdownRequest_sbe_block_length());
    shm_tensorpool_driver_messageHeader_set_templateId(hdr, shm_tensorpool_driver_shmDriverShutdownRequest_sbe_template_id());
    shm_tensorpool_driver_messageHeader_set_schemaId(hdr, shm_tensorpool_driver_shmDriverShutdownRequest_sbe_schema_id());
    shm_tensorpool_driver_messageHeader_set_version(hdr, shm_tensorpool_driver_shmDriverShutdownRequest_sbe_schema_version());

    shm_tensorpool_driver_shmDriverShutdownRequest_reset(
        codec,
        ...
        shm_tensorpool_driver_shmDriverShutdownRequest_sbe_block_length(),
        shm_tensorpool_driver_shmDriverShutdownRequest_sbe_schema_version());

    return codec;
}

SBE_ONE_DEF struct shm_tensorpool_driver_shmDriverShutdownRequest *shm_tensorpool_driver_shmDriverShutdownRequest_wrap_for_encode(
    struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec,
    char *buffer,
    const uint64_t offset,
    const uint64_t buffer_length)
{
    return shm_tensorpool_driver_shmDriverShutdownRequest_reset(
        codec,
        buffer,
        offset,
        buffer_length,
...
SBE_ONE_DEF struct shm_tensorpool_driver_shmDriverShutdownRequest *shm_tensorpool_driver_shmDriverShutdownRequest_wrap_for_decode(
    struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec,
    char *buffer,
    const uint64_t offset,
    const uint64_t acting_block_length,
...
SBE_ONE_DEF struct shm_tensorpool_driver_shmDriverShutdownRequest *shm_tensorpool_driver_shmDriverShutdownRequest_sbe_rewind(
    struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
    return shm_tensorpool_driver_shmDriverShutdownRequest_wrap_for_decode(
        codec,
        codec->buffer,
        codec->offset,
...
SBE_ONE_DEF uint64_t shm_tensorpool_driver_shmDriverShutdownRequest_encoded_length(
    const struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
    return shm_tensorpool_driver_shmDriverShutdownRequest_sbe_position(codec) - codec->offset;
}

SBE_ONE_DEF const char *shm_tensorpool_driver_shmDriverShutdownRequest_buffer(
    const struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
    return codec->buffer;
}

SBE_ONE_DEF char *shm_tensorpool_driver_shmDriverShutdownRequest_mut_buffer(
    struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
    return codec->buffer;
}

SBE_ONE_DEF uint64_t shm_tensorpool_driver_shmDriverShutdownRequest_buffer_length(
    const struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
    return codec->buffer_length;
}

SBE_ONE_DEF uint64_t shm_tensorpool_driver_shmDriverShutdownRequest_acting_version(
    const struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
...
SBE_ONE_DEF const char *shm_tensorpool_driver_shmDriverShutdownRequest_token_character_encoding(void)
{
    return "null";
}

SBE_ONE_DEF uint64_t shm_tensorpool_driver_shmDriverShutdownRequest_token_since_version(void)
{
    return 0;
}

SBE_ONE_DEF bool shm_tensorpool_driver_shmDriverShutdownRequest_token_in_acting_version(
    const struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
#if defined(__clang__)
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wtautological-compare"
#endif
    return codec->acting_version >= shm_tensorpool_driver_shmDriverShutdownRequest_token_since_version();
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
}
...
SBE_ONE_DEF uint32_t shm_tensorpool_driver_shmDriverShutdownRequest_token_length(
    const struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
    uint32_t length;
...
SBE_ONE_DEF const char *shm_tensorpool_driver_shmDriverShutdownRequest_token(
    struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
...
SBE_ONE_DEF uint64_t shm_tensorpool_driver_shmDriverShutdownRequest_get_token(
    struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec,
    char *dst,
...
SBE_ONE_DEF struct shm_tensorpool_driver_shmDriverShutdownRequest_string_view shm_tensorpool_driver_shmDriverShutdownRequest_get_token_as_string_view(
    struct shm_tensorpool_driver_shmDriverShutdownRequest *const codec)
{
    uint32_t length_field_value = shm_tensorpool_driver_shmDriverShutdownRequest_token_length(codec);
    const char *field_ptr = codec->buffer + shm_tensorpool_driver_shmDriverShutdownRequest_sbe_position(codec) + 4;
    if (!shm_tensorpool_driver_shmDriverShutdownRequest_set_sbe_position(
