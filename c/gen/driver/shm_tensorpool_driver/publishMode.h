...
#ifndef _SHM_TENSORPOOL_DRIVER_PUBLISHMODE_H_
#define _SHM_TENSORPOOL_DRIVER_PUBLISHMODE_H_
...
enum shm_tensorpool_driver_publishMode
{
    shm_tensorpool_driver_publishMode_REQUIRE_EXISTING = (uint8_t)1,
    shm_tensorpool_driver_publishMode_EXISTING_OR_CREATE = (uint8_t)2,
    shm_tensorpool_driver_publishMode_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool shm_tensorpool_driver_publishMode_get(
    const uint8_t value,
    enum shm_tensorpool_driver_publishMode *const out)
{
    ...
    {
        case (uint8_t)1:
             *out = shm_tensorpool_driver_publishMode_REQUIRE_EXISTING;
             return true;
        case (uint8_t)2:
             *out = shm_tensorpool_driver_publishMode_EXISTING_OR_CREATE;
             return true;
        case (uint8_t)255:
             *out = shm_tensorpool_driver_publishMode_NULL_VALUE;
             return true;
    }
