...
#ifndef _SHM_TENSORPOOL_DRIVER_ROLE_H_
#define _SHM_TENSORPOOL_DRIVER_ROLE_H_
...
enum shm_tensorpool_driver_role
{
    shm_tensorpool_driver_role_PRODUCER = (uint8_t)1,
    shm_tensorpool_driver_role_CONSUMER = (uint8_t)2,
    shm_tensorpool_driver_role_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool shm_tensorpool_driver_role_get(
    const uint8_t value,
    enum shm_tensorpool_driver_role *const out)
{
    ...
    {
        case (uint8_t)1:
             *out = shm_tensorpool_driver_role_PRODUCER;
             return true;
        case (uint8_t)2:
             *out = shm_tensorpool_driver_role_CONSUMER;
             return true;
        case (uint8_t)255:
             *out = shm_tensorpool_driver_role_NULL_VALUE;
             return true;
    }
