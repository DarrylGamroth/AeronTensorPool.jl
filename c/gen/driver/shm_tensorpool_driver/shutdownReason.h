...
#ifndef _SHM_TENSORPOOL_DRIVER_SHUTDOWNREASON_H_
#define _SHM_TENSORPOOL_DRIVER_SHUTDOWNREASON_H_
...
enum shm_tensorpool_driver_shutdownReason
{
    shm_tensorpool_driver_shutdownReason_NORMAL = (uint8_t)0,
    shm_tensorpool_driver_shutdownReason_ADMIN = (uint8_t)1,
    shm_tensorpool_driver_shutdownReason_ERROR = (uint8_t)2,
    shm_tensorpool_driver_shutdownReason_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool shm_tensorpool_driver_shutdownReason_get(
    const uint8_t value,
    enum shm_tensorpool_driver_shutdownReason *const out)
{
    ...
    {
        case (uint8_t)0:
             *out = shm_tensorpool_driver_shutdownReason_NORMAL;
             return true;
        case (uint8_t)1:
             *out = shm_tensorpool_driver_shutdownReason_ADMIN;
             return true;
        case (uint8_t)2:
             *out = shm_tensorpool_driver_shutdownReason_ERROR;
             return true;
        case (uint8_t)255:
             *out = shm_tensorpool_driver_shutdownReason_NULL_VALUE;
             return true;
    }
