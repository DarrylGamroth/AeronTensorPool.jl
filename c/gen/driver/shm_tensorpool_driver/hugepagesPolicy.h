...
#ifndef _SHM_TENSORPOOL_DRIVER_HUGEPAGESPOLICY_H_
#define _SHM_TENSORPOOL_DRIVER_HUGEPAGESPOLICY_H_
...
enum shm_tensorpool_driver_hugepagesPolicy
{
    shm_tensorpool_driver_hugepagesPolicy_UNSPECIFIED = (uint8_t)0,
    shm_tensorpool_driver_hugepagesPolicy_STANDARD = (uint8_t)1,
    shm_tensorpool_driver_hugepagesPolicy_HUGEPAGES = (uint8_t)2,
    shm_tensorpool_driver_hugepagesPolicy_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool shm_tensorpool_driver_hugepagesPolicy_get(
    const uint8_t value,
    enum shm_tensorpool_driver_hugepagesPolicy *const out)
{
    ...
    {
        case (uint8_t)0:
             *out = shm_tensorpool_driver_hugepagesPolicy_UNSPECIFIED;
             return true;
        case (uint8_t)1:
             *out = shm_tensorpool_driver_hugepagesPolicy_STANDARD;
             return true;
        case (uint8_t)2:
             *out = shm_tensorpool_driver_hugepagesPolicy_HUGEPAGES;
             return true;
        case (uint8_t)255:
             *out = shm_tensorpool_driver_hugepagesPolicy_NULL_VALUE;
             return true;
    }
