...
#ifndef _SHM_TENSORPOOL_DRIVER_LEASEREVOKEREASON_H_
#define _SHM_TENSORPOOL_DRIVER_LEASEREVOKEREASON_H_
...
enum shm_tensorpool_driver_leaseRevokeReason
{
    shm_tensorpool_driver_leaseRevokeReason_DETACHED = (uint8_t)1,
    shm_tensorpool_driver_leaseRevokeReason_EXPIRED = (uint8_t)2,
    shm_tensorpool_driver_leaseRevokeReason_REVOKED = (uint8_t)3,
    shm_tensorpool_driver_leaseRevokeReason_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool shm_tensorpool_driver_leaseRevokeReason_get(
    const uint8_t value,
    enum shm_tensorpool_driver_leaseRevokeReason *const out)
{
    ...
    {
        case (uint8_t)1:
             *out = shm_tensorpool_driver_leaseRevokeReason_DETACHED;
             return true;
        case (uint8_t)2:
             *out = shm_tensorpool_driver_leaseRevokeReason_EXPIRED;
             return true;
        case (uint8_t)3:
             *out = shm_tensorpool_driver_leaseRevokeReason_REVOKED;
             return true;
        case (uint8_t)255:
             *out = shm_tensorpool_driver_leaseRevokeReason_NULL_VALUE;
             return true;
    }
